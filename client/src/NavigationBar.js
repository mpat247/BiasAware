...
const Brand = ({ isCentered }) => (
  <motion.div
    id='brand-container'
    className={`brand-container ${isCentered ? 'centered' : ''}`}
  >
...
const NavMenu = ({
  ...
  <motion.div id='navMenu' style={{ display: 'flex', alignItems: 'center' }}>
    ...
    >
      <LinkItem to="/" icon={<HomeOutlined />} label="Home" isMobile={isMobile} iconStyle={iconStyle} linkStyle={linkStyle} tooltip="Go to Home Page" />
      <LinkItem to="/Statistics" icon={<BarChartOutlined />} label="Statistics" isMobile={isMobile} iconStyle={iconStyle} linkStyle={linkStyle} tooltip="View Statistics" />
      <LinkItem to="/Engineering" icon={<SettingOutlined />} label="Engineering" isMobile={isMobile} iconStyle={iconStyle} linkStyle={linkStyle} tooltip="Explore Engineering" />
      <LinkItem to="/Neighborhood" icon={<ClusterOutlined />} label="Neighborhood" isMobile={isMobile} iconStyle={iconStyle} linkStyle={linkStyle} tooltip="View Neighborhood" />
      <LinkItem to="/Gallery" icon={<PictureOutlined />} label="Gallery" isMobile={isMobile} iconStyle={iconStyle} linkStyle={linkStyle} tooltip="View Gallery" />
    </Menu>
  </motion.div>
);
...
const NavigationBar = () => {
  ...
  useEffect(() => {
    const updateUI = () => {
      ...
      setIsNavMenuUnderBrand(navMenuRect && brandRect && navMenuRect.top > brandRect.bottom);
    };
