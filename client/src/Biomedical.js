  ...
  return (
    ...
    <div className="sidebar-icons">
      ...
      <main className="main-content">
        <div className="title-aerospace">BIOMEDICAL ENGINEER</div>
        <div className="grid-container">
          <div className="grid-item item-large">
          <img src="/biomedical/BioBlack.gif" alt="aero4" />
          </div>
          <div className="grid-item item-medium">
          <img src="/biomedical/BIO_R.gif" alt="aero4" />
          </div>
          <div className="grid-item item-long-prop">
          <img src="/biomedical/Bio_Stat1.gif" alt="aero4" />
          </div> 
          <div className="grid-item item-small2">
          <img src="/biomedical/bio1.jpeg" alt="bio1" />
          </div>
          <div className="grid-item item-small3">
            <img src="/biomedical/bio2.png" alt="bio2" />
            </div>
          
          <div className="grid-item item-small6">
          <img src="/biomedical/bio3.png" alt="bio3" />
          </div>
          <div className="grid-item item-small7">
          <img src="/biomedical/bio4.jpeg" alt="bio4" />
          </div>
          <div className="grid-item item-long-mat">
          <img src="/biomedical/Bio_LGB.gif" alt="aero4" />
          </div>
