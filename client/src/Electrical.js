  ...
  return (
    ...
    <div className="sidebar-icons">
      ...
      <main className="main-content">
        <div className="title-aerospace">ELECTRICAL ENGINEER</div>
        <div className="grid-container">
          <div className="grid-item item-large">
          <img src="/electrical/EleBlack.gif" alt="aero4" />
          </div>
          <div className="grid-item item-medium">
          <img src="/electrical/ELE_R.gif" alt="aero4" />
          </div>
          <div className="grid-item item-long-prop">
          <img src="/electrical/ELEGENDER.gif" alt="chem_stat" />
            </div> 
          <div className="grid-item item-small2">
          <img src="/electrical/ele1.jpeg" alt="ele1" />
          </div>
          <div className="grid-item item-small3">
          <img src="/electrical/ele2.png" alt="ele2" />
          </div>
          
          <div className="grid-item item-small6">
          <img src="/electrical/ele3.jpeg" alt="ele3" />
          </div>
          <div className="grid-item item-small7">
          <img src="/electrical/ele4.jpeg" alt="ele2" />
          </div>
          <div className="grid-item item-long-mat">
          <img src="/electrical/ELE_LGB.gif" alt="aero4" />
          </div>
