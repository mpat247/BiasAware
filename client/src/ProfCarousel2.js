...
const ProfCarousel2 = (selectedProfession) => {
    ...
    useEffect(() => {
        ...
        const fetchImages = async () => {
            try {
                ...
                // Move the setSlideImages call inside useEffect after fetching slides
                // Note: If the slides are directly related to the fetched data, consider integrating this logic more closely with the fetch result.
            } catch (err) {
