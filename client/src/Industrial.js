  ...
  return (
    ...
    <div className="sidebar">
      ...
      <main className="main-content">
        <div className="title-aerospace">INDUSTRIAL ENGINEER</div>
        <div className="grid-container">
          <div className="grid-item item-large">
          <img src="/industrial/IndBlack.gif" alt="aero4" />
          </div>
          <div className="grid-item item-medium">
          <img src="/industrial/IND_R.gif" alt="aero4" />
          </div>
          <div className="grid-item item-long-prop">
          <img src="/industrial/Ind_Stat1.gif" alt="chem_stat" /></div> 
          <div className="grid-item item-small2">
          <img src="/industrial/ind1.jpeg" alt="ind1" />
          </div>
          <div className="grid-item item-small3">
          <img src="/industrial/ind2.jpeg" alt="ind2" />
          </div>
          
          <div className="grid-item item-small6">
          <img src="/industrial/ind3.jpeg" alt="ind3" />
          </div>
          <div className="grid-item item-small7">
          <img src="/industrial/ind4.jpeg" alt="ind4" />
          </div>
          <div className="grid-item item-long-mat">
          <img src="/industrial/IND_LGB.gif" alt="aero4" />
          </div>
