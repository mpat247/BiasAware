  ...
  return (
    ...
    <div className="sidebar-icons">
      ...
      <main className="main-content">
        <div className="title-aerospace">CHEMICAL ENGINEER</div>
        <div className="grid-container">
          <div className="grid-item item-large">
          <img src="/chemical/ChemBlack.gif" alt="aero4" />
          </div>
          <div className="grid-item item-medium">
          <img src="/chemical/CHEM_R.gif" alt="aero4" />
          </div>
          <div className="grid-item item-long-prop">
          <img src="/chemical/Chem_Stat1.gif" alt="chem_stat" />
          </div> 
          <div className="grid-item item-small2">
          <img src="/chemical/chem1.png" alt="chem1" />
          </div>
          <div className="grid-item item-small3">
          <img src="/chemical/chem2.jpeg" alt="chem1" />
          </div>
          
          <div className="grid-item item-small6">
          <img src="/chemical/chem3.jpeg" alt="chem3" />
          </div>
          <div className="grid-item item-small7">
          <img src="/chemical/chem4.jpg" alt="chem4" />
          </div>
          <div className="grid-item item-long-mat">
          <img src="/chemical/CHEM_LGB.gif" alt="aero4" />
          </div>
